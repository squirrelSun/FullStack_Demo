...
public class File_test {
	...
	public void test2() {
		...
		File file2 = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\World.txt");//绝对路径
		...
		System.out.println("-----------------------");
		//适用于文件目录
		File file3 = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src");
	...
	@Test//判断相关
	public void test3() {
		File file1 = new File("src\\IO\\World.txt");
		File file2 = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO");
	...
	public void test4() {
		...
		//文件目录相关
		File file2 = new File("src\\IO\\IOTest\\test2");
		File file3 = new File("src\\IO\\IOTest\\test3");
