...
public class IO_test {
	...
	public void testFileReader1() {
		// 实例化对象，指明操作的文件
		File file1 = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\World.txt");
		// 提供具体的流
	...
	public void testFileReader2() {
		// File类的实例化
		File file = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\World.txt");
		FileReader fr = null;
		try {
			// FileReader流的实例化
	...
	public void testFileWriter() throws IOException {
		// 提供File类的对象，指明操作的文件
		File file = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\Hello.txt");
		// 提供FileWriter的对象
		FileWriter fw = null;
		// 对写出流初始化
...
//		fw = new FileWriter(file,true);		//在执行写入操作时，追加在原文件后面（false：执行写入操作时，覆盖原文件写入）
	...
	public void testFileReaderAndWriter() {
		...
		File file1 = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\World.txt");// 读入文件
		File file2 = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\Hello.txt");// 写出文件
	...
	public void testFileInoutOutputStream() {
		// 创建文件及流对象
		File file1 = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\image\\timg.jpg");
		File file2 = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\image\\timg01.jpg");
	...
	public void testCopyFile() {
		...
		File out = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\image\\timg02.jpg");
		copyFile(in, out);
	...
	/*
	 * 缓冲流 提升读取和写入的速度（内部提供了一个缓冲区）
	 */
	@Test
	public void testCopyBuffer1() {
		long start = System.currentTimeMillis();
		File in = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\image\\timg.jpg");
		File out = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\image\\timg03.jpg");
	...
	public void testCopyBuffer2() {
		long start = System.currentTimeMillis();
		File in = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\World.txt");
		File out = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\World1.txt");
		copyBufferStream(in, out);
		long end = System.currentTimeMillis();
		System.out.println("复制成功，用时：" + (end - start) + "ms");// 1ms
	}
...
//				in.close();
	...
	public void testStreamReaderWriter() throws IOException {
		FileInputStream fis = new FileInputStream("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\World.txt");
		FileOutputStream fos = new FileOutputStream("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\World1.txt");
...
//		OutputStreamWriter osw = new OutputStreamWriter(fos);	//无第二个参数，表示使用系统默认的字符集
	...
	public void testObjectOutputStream() {
		...
		try {
			oos = new ObjectOutputStream(
					new FileOutputStream("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\object.dat"));
	...
	public void testObjectInputStream() {
		...
		try {
			ois = new ObjectInputStream(
					new FileInputStream("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\object.dat"));
	...
	public void testRandonAccessFile1() {
		...
		try {
			raf1 = new RandomAccessFile(new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\image\\timg.jpg"),
					"r");
			raf2 = new RandomAccessFile(
					new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\image\\timg06.jpg"), "rw");
			byte[] buffer = new byte[1024];
			int len;
	...
	public void testRandonAccessFile2() throws IOException {
		RandomAccessFile raf1 = new RandomAccessFile(
				new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\World2.txt"), "rw");
	...
	public void testAddFile() throws IOException {
		...
		StringBuilder builder = new StringBuilder(
				(int) new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\World2.txt").length());
		int len;
		while ((len = raf1.read(buffer)) != -1) {
	...
	public void testPoint() {
		...
		try {
			FileOutputStream fos = new FileOutputStream(
					new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\World.txt"));
	...
	public void testDataOutputStream() {
		...
		try { // 创建连接到指定文件的数据输出流对象
			dos = new DataOutputStream(
					new FileOutputStream("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\data.txt"));
	...
	public void testDataInputStream() {
		...
		try {
			dis = new DataInputStream(
					new FileInputStream("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\IO\\data.txt"));
