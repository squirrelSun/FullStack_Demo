...
public class Pic_test {
	...
	public void test1() {
		...
		File out = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\JAVA\\IO\\image\\timg04.jpg");
	...
	public void test2() {
		long start = System.currentTimeMillis();
		File in = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\JAVA\\IO\\image\\timg04.jpg");
		File out = new File("E:\\Java\\WorkSpace\\eclipse\\Full_Stack\\src\\JAVA\\IO\\image\\timg05.jpg");
		scretBufferStream(in , out);
		long end = System.currentTimeMillis();
		System.out.println("加密成功，用时：" + (end - start) + "ms");
	}
